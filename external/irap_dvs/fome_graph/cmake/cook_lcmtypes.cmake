...
function(lcmtypes_build_c)
    ...
    file(GLOB _lcmtypes_c_files "${PROJECT_SOURCE_DIR}/pod-build/lcmdefs/c/*.c")
    file(GLOB _lcmtypes_h_files "${PROJECT_SOURCE_DIR}/pod-build/lcmdefs/c/*.h")
...
function(lcmtypes_build_cpp)
    ...
    foreach (PACKAGE ${LCM_PCK_LIST})
        file(GLOB __tmphppfile "${PROJECT_SOURCE_DIR}/pod-build/lcmdefs/cpp/${PACKAGE}/*.hpp")
...
function(lcmtypes_build_java)
    ...
    file(GLOB_RECURSE _lcmtypes_java_files "${PROJECT_SOURCE_DIR}/pod-build/lcmdefs/java/*.java")
...
function(lcmtypes_build_python)
    ...
    set(_lcmtypes_python_dir ${PROJECT_SOURCE_DIR}/pod-build/lcmdefs/python)
